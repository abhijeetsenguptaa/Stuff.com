...
checkOut.addEventListener("click", () => {
  cartView.forEach((element, index) => {
    ...
    fetch("https://defiant-plum-bat.cyclic.app/purchase/add", {
      method: "POST",
      headers: {
  ...
  localStorage.setItem('cartView',null);
  leftBox.innerHTML = null;
  totalAmount.innerText = 00;
  totalAmount1.innerText = 00;
  leftBox.innerHTML = `<div><h1>Order Successfully Placed!!!!</h1></div>`
});
